Public Class Form3
    ...
    Private Sub Button115_Click(sender As Object, e As EventArgs) Handles Button115.Click
        ...
        For i As Integer = 0 To 114
            If (btnState(i) <> 0) Then
                startPage = SurahStart(i)
                endPage = SurahStart(getRangeEnding(i, btnState(i)))

                If (btnState(i) = 2) Then
                    moutouna = "ضعيف"
                Else
                    moutouna = "متين"
                End If
