...
Partial Class AboutBox1
    ...
    Private Sub InitializeComponent()
        ...
        Me.TextBoxDescription.Text = "Description :" & _
            ...
            "(Au moment de l'exécution, le texte des étiquettes sera remplacé par les informations d'assembly de l'application." & _
            Global.Microsoft.VisualBasic.ChrW(13) & Global.Microsoft.VisualBasic.ChrW(10) & _
            "Personnalisez les informations d'assembly de l'application dans le volet Application du Concepteur de projets.)"
        '
        'OKButton
        '
